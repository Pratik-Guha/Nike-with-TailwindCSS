...
const Hero = () => {
  const [bighShoeImg, setbighShoeImg] = useState(bigShoe1);
  return (
    <section
      id="home"
      className="w-full flex flex-col xl:flex-row justify-center min-h-screen gap-10 max-container"
    >
      <div className=" relative xl:w-2/5 flex justify-center flex-col items-start w-full max-xl:padding-x pt-28">
